...
\input{secciones/repaso.tex}
\input{secciones/inecuaciones.tex}
\input{secciones/limites_y_derivadas.tex}
\input{secciones/Rutinarios.tex}
\input{secciones/resumen.tex}
\input{secciones/NoRutinarios.tex}
\input{secciones/analisisComputacional.tex}Función racional creciente y decreciente antes y después de $c$ respectivamente.
